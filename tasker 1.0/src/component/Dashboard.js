...
function InvoiceScreen() {
 ...
 // UseEffects to for pagination
  ...
  const handleCustomerRowDoubleClick = (customerName) => {
    ...
    closeSearchModal(); // Close the customer search modal if desired
  };
  ...
  const handleSearchColumnChange = (event) => {
    ...
    setSearchTerm(''); // Reset the search term when changing the column
  };
  ...
  return (
      <div className="invoice-screen">
                ...
                <div className="edit-invoice-items">
                  ...
                  <div className="edit-invoice-footer">
                    ...
                    <div className="signature">
                      <p>Signature/Name:<span>&nbsp; {sign}</span></p>
                    </div>
                  </div>
                  <button className="submit-button" onClick={handleUpdateInvoice}>Update Invoice</button> &nbsp; 
                  <button className="submit-button" onClick={handleSign}>Paid</button>
            </div>
          ) : (
          ...
          />
            ...
            <button onClick={closeModal} className="invoice-close-btn">❌</button>
              </div>
            )}
          <button className="add-invoice-btn" onClick={openModal}>+</button>
        </div>
