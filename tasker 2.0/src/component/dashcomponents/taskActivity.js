...
const Ta = ({ id, text }) => {
    ...
    if (deletedActivity) {
      ...
      setSelectedActivities((prevSelectedActivities) =>
        prevSelectedActivities.filter(
          (id) => id !== deletedActivity.activity_id
        )
      );
    }
  };
  ...
  const openModal = (event) => {
    ...
    if (matchingTask) {
      ...
      const activityIds = matchingActivities.map(
  ...
  return (
    <div className="task">
      <div className="main">
        ...
        <button onClick={openModal} className="ta-modal-btn">
          Edit
        </button>
      </div>
      ...
      {isModalOpen && (
        <div className="modal">
          ...
          <div className="ta-modal-table-container"> 
          ...
          <table className="act-table">
            ...
            <tbody>
                ...
                if (
                  ...
                  return (
                    <tr key={item.taskActivity_id}>
                      ...
                      <td>
                        <button
                          onClick={() => handleDeleteRow(item.taskActivity_id)}
              ...
              <tr>
                <td>
                  <Select
                    ...
                    onChange={(selectedOption) =>
                      setNewRow({ activity: selectedOption })
                    }
                    options={activity
                      .filter(
                        (item) =>
                ...
                <td>
                  <button onClick={handleAddRow} className="ta-act-add">
                    +
                  </button>
                </td>
              </tr>
          ...
          <button onClick={closeModal} className="ta-modal-close-btn">
            Close
          </button>
          </div>
        </div>
